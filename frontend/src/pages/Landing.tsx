  ...
  return (
    ...
    <div className="h-screen w-full flex flex-col font-dmsans bg-white text-slate-900 overflow-hidden">
      ...
      <main className="flex-1 flex flex-col justify-center px-8 md:px-16 max-w-7xl mx-auto w-full pb-12">
        ...
        <div className="flex items-center w-full max-w-4xl border-t border-b border-gray-100 py-10 mb-auto">
          ...
          <div className="flex flex-col flex-1 pl-12 border-r border-gray-200">
        ...
        <div className="text-center text-slate-500 text-base mt-8">
          New to ChuoSurvivor? Tap <span className="text-slate-900 font-bold">My units</span> above to get started — or pick up where you left off.
        </div>
