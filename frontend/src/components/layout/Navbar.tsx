export default function Navbar() {
  return (
    // Removed absolute positioning so it flows naturally, changed text to slate-900 (almost black)
    <nav className="w-full bg-white text-slate-900 px-8 py-6 flex items-center justify-between font-touchme">
      ...
      <div className="flex items-center gap-10">
        ...
        {/* The Brand - Emulating the AFTERNOW bold text */}
        ...
        {/* My Units Pill - Emulating your reference: bigger, thicker border */}
        <button className="border-2 border-[#b6feb5] text-slate-900 rounded-full px-8 py-2.5 text-base font-bold transition-all hover:bg-[#b6feb5]">
          My units
        </button>
